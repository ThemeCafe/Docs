...
=== "Flips"
    ...
    - [Flips](https://github.com/Alcaro/Flips/releases).
    - Your ORIGINAL UNMODIFIED menu files.
    - Your modified file.
...
- The BPS Patches of your theme, custom music or a PNG image of your splash screen.
- A 720p Preview of your theme for the Launcher Menu (The menu with the Apps) and the Wara Wara Plaza (The menu with the Miis).
    ...
    - **Themes that don't use Screnshots for previews will be removed from Themezer.**
