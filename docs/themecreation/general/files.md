...
If you want to retrieve the Wii U Menu Files you can use any of the following

- [Themiify](#themiify) (Recommended)
    - You must have previously used Themiify at least once before
- [JNUSTool](#jnustool)
- [FTP](#ftp)

=== "Themiify"

    ## Using Themiify to Retrieve Menu Files

    !!! warning "You must have previously used Themiify at least once before"

    - Open your Wii U SD card on your device
    - Go to the folder `SD:\themiify\cache\Common\Package` and copy the files `Men.pack` and `Men2.pack` to your device
    - Go to the folder `SD:\themiify\cache\Common\Sound\Men` and copy the file `cafe_barista_men.bfsar` to your device
