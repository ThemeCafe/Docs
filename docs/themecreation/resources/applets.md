...
-   **Light Icons**
    ...
    ![Light Mode Applets](imgs/applets/al.webp)
...
-   **Dark Icons**
    ...
    ![Dark Mode Applets](imgs/applets/ad.webp)
...
![Applets Visual Guide](imgs/applets/a1.webp)

- Double-click the same thumbnail to open the color picker

![Applets Visual Guide](imgs/applets/a2.webp)

![Applets Visual Guide](imgs/applets/a3.webp)

- Save your changes ( `Ctrl + S` / `File -> Save` )

- Return to the icons.psd file

![Applets Visual Guide](imgs/applets/a4.webp)

• Navigate to `File -> Export Layers...`

![Applets Visual Guide](imgs/applets/a5.webp)

• Uncheck `Trim transparent parts`

![Applets Visual Guide](imgs/applets/a6.webp)
...
![Applets Final](imgs/applets/a7.webp)
