...
Apply the patch to a copy of your `Men2.pack` file ([Patching](../themecreation/general/patching.md)) and come back here when you're done
...
!!! success
    ...
    Your Scrolling animation is done and you can now test it [StyleMiiU](../themecreation/general/loading.md#StyleMiiU-plugin)
